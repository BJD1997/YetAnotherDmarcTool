...
function WelcomeStep({ status, onNext }: { status: OnboardingStatus; onNext: () => void }) {
  return (
    <div>
      <h2 style={{ marginTop: 0 }}>Welcome to DMARCwatch</h2>
      <p>
    ...
    return (
      <div>
        ...
        <div className="alert alert--good">
          ...
          domain, we'll generate a dedicated DMARCwatch-hosted reporting address for it automatically.
        </div>
  ...
  return (
    <div className="alert alert--good" style={{ marginTop: "0.75rem" }}>
      ...
      <div className="chip-row" style={{ marginTop: "0.4rem" }}>
        <code>{address}</code>
        <span className="badge badge--good">hosted by DMARCwatch</span>
      </div>
    </div>
  );
}
