...
// pattern already used below for a dropped pct=. Both sides must already be
...
function isRelaxation(current: DmarcPolicy | undefined, generated: DmarcPolicy): boolean {
...
function effectiveCurrentPolicies(tags: Record<string, string> | undefined) {
...
function effectiveGeneratedPolicies(policy: DmarcPolicy, sp: DmarcPolicy | "", np: DmarcPolicy | "") {
...
function findRelaxations(currentTags: Record<string, string> | undefined, policy: DmarcPolicy, sp: DmarcPolicy | "", np: DmarcPolicy | ""): string[] {
